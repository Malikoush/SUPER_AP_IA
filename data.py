...
à_la_mort_boost_aleatoire = Capacité("à_la_mort_boost_aleatoire", Evenement.MORT,lambda animal, equipe=None,position=None: Effet.boost_aleatoire(animal, equipe=equipe,scale_boost=True))
...
à_la_mort_invoque_zombie = Capacité("à_la_mort_invoque_zombie", Evenement.MORT, lambda  position,animal, equipe=None: Effet.invoque_zombie(position=position, equipe=equipe, zombie=generer_zombie_criquet(animal.niveau),joueur =animal.joueur))
